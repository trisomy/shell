...
function(lemon_scan_package_files PATH)
	...
	lemon_scan_files(LEMON_PACKAGE_C_CXX_SOURCE_FILES "Source Files" ${PATH}/sources PATTERNS *.c *.cpp *.cc *.cxx *.mm)
	...
	lemon_scan_files(LEMON_PACKAGE_UNITTEST_C_CXX_SOURCE_FILES "Source Files" ${PATH}/unittest PATTERNS *.c *.cpp *.cc *.cxx *.mm)

	lemon_scan_files(LEMON_PACKAGE_EXE_HEADER_FILES "Include Files" ${PATH}/exec PATTERNS *.h *.hpp *.hxx)
	lemon_scan_files(LEMON_PACKAGE_EXE_SOURCE_FILES "Source Files" ${PATH}/exec PATTERNS *.c *.cpp *.cc *.cxx *.mm)
...
function(lemon_load_package PATH)
	...
	if(${LEMON_PACKAGE_TYPE} STREQUAL "SHARED")
		...
		if(APPLE)
			set_target_properties(${LEMON_PACKAGE_NAME} PROPERTIES MACOSX_RPATH ON)
		endif()
